...
⚠️ **Warning:** For ITNs to work when passed to `site::site_parameters()` you will need to specify a column: `site_file$interventions$itn$implementation$itn_input_dist` indicating the size of the model ITN distributions each year. This is **not** the same as ITN usage. Please call `stop_missing_itn_input_dist()` for more information.
